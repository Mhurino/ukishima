...
function calendar(mon: string): void { root.toggleSurface(mon, "calendar"); }
        ...
        function beats(mon: string): void { root.toggleSurface(mon, "beats"); }
    ...
    Variants {
        ...
        PanelWindow {
            ...
            onMonFullscreenChanged: {
                console.log("UKISHIMA FULLSCREEN:", modelData.name, monFullscreen);
                if (monFullscreen) {
            ...
            mask: monFullscreen
                ...
                : (modal
                    ...
                    : (pill.stripBar
                        ? pillRegion
                        : (Flags.autoHide
                            ? (pill.revealSession || pill.transientLive
                                ? revealPillRegion
                                : (pill.expanded ? pillRegion : revealRegion))
                            : pillRegion)))
            ...
            FocusScope {
                ...
                Pill {
                    ...
                    monFullscreen: overlay.monFullscreen
                    ...
                    transform: Translate {
                        y: pill.hidden ? -(pill.height + overlay.topGap) : 0
                        Behavior on y {
                            NumberAnimation {
                                duration: Motion.morph
                                easing.type: Motion.easeMorph
