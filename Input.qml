...
SettingsSurface {
    ...
    readonly property string inputPath: Config.hyprPath("modules", "input.lua")
    readonly property string envPath: Config.hyprPath("modules", "env.lua")
    readonly property string autostartPath: Config.hyprPath("modules", "autostart.lua")
